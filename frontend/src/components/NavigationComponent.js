  ...
  const sideList = side => (
    <div className='list' role='presentation' onClick={toggleDrawer(side, false)} onKeyDown={toggleDrawer(side, false)}>
      <List>
          ...
          <ListItem>Visa allt <i class='fas fa-sort-down'></i></ListItem>
          <ListItem>Överdelar <i class='fas fa-sort-down'></i></ListItem>
          <ListItem>Nederdelar <i class='fas fa-sort-down'></i></ListItem>
          <ListItem>Jumpsuits</ListItem>
          <ListItem>Ytterkläder <i class='fas fa-sort-down'></i></ListItem>
